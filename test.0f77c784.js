...
})({"g8h7e":[function(require,module,exports,__globalThis) {
...
const render = (array, element)=>{
    const item = array.map(({ id, name, age, city, isStudent })=>{
        return `<li id="${id}">
   <h2>\u{406}\u{43C}\u{44C}\u{44F}: ${name}</h2>
   <p>\u{412}\u{456}\u{43A} :${age}</p>
   <p>\u{41C}\u{456}\u{441}\u{446}\u{435} :${city}</p>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"cS42h"}]},["g8h7e","2R06K"], "2R06K", "parcelRequirefc40", {})
